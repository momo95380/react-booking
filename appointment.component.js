  ...
  (function (_Component) {
    ...
    function AppointmentComponent(props) {
      ...
      _this = (0, _possibleConstructorReturn2["default"])(
        this,
        (0, _getPrototypeOf2["default"])(AppointmentComponent).call(this, props)
      );
      ...
      },
      {
        ...
        value: function confirmAppointment(slot) {
          var data = {
            ...
            slotTime: ""
              .concat(
                (0, _moment["default"])(slot.start).format("HH:mm"),
                " - "
              )
              .concat((0, _moment["default"])(slot.end).format("HH:mm")),
          };
      ...
      },
      {
        ...
        value: function render() {
          ...
          var appointmentsInDate = appointments.filter(function (app) {
            return (0, _moment["default"])(app.start).isSame(
              (0, _moment["default"])(startDate),
              "date"
            );
          });
                  ...
                  appointmentsInDate.map(function (i) {
                    return _react["default"].createElement(
                      "div",
                      {
                        ...
                        key: i.id,
                        className:
                          _this2.state.selectedSlot === i.id
                      ...
                      _react["default"].createElement(
                        ...
                        _react["default"].createElement(
                          "span",
                          null,
                          (0, _moment["default"])(i.start).format("HH:mm")
                        ),
                        " -",
                        " ",
                        _react["default"].createElement(
                          "span",
                          null,
                          (0, _moment["default"])(i.end).format("HH:mm")
                        )
                      ),
                      _react["default"].createElement(
                        "div",
